    ...
    <div class="row">
      <div class="col-sm-6 col-sm-offset-6 col-xs-12 content">
        ...
        <div class="editContent"  style="height:235px;">
          ...
          &nbsp;&nbsp;And we never go it alone. We support and are supported to develop our own personal results stories.  </p>
        </div> 
      </div>
    </div><!-- /.row-->
  </div><!-- /.container -->
            ...
            <div class="row">
              <div class="col-md-4">
                ...
                <div class="block-heading-two">
                  <h3><span>EBM One-Stop Service for Investors</span></h3>
                </div>
                <p>We make your business GO.. while you make it GROWTH Your Benefits, Our Achievement.</p>
              </div>
              <div class="col-md-4">
                <div class="block-heading-two">
                  ...
                  <!-- Panel heading -->
                   <div class="panel-heading">
                    <h4 class="panel-title">
                      ...
                      <i class="fa fa-angle-right"></i> Apply CV NOW
                      </a>
                    </h4>
                   </div>
                  ...
                  <div class="panel">
                   <div class="panel-heading">
                    <h4 class="panel-title">
                      ...
                      <i class="fa fa-angle-right"></i> Apply CV by Telegram
                      </a>
                    </h4>
                   </div>
                   <div id="collapseTwo-alt3" class="panel-collapse collapse">
                    <div class="panel-body">
                    https://t.me/Vitu_Phang
                    </div>
                   </div>
                  </div>
                  <div class="panel">
                   <div class="panel-heading">
                    <h4 class="panel-title">
                      ...
                      <i class="fa fa-angle-right"></i> Facebook Page
                      </a>
                    </h4>
                   </div>
                   <div id="collapseThree-alt3" class="panel-collapse collapse">
                    <div class="panel-body">
                    https://www.facebook.com/ejobpage
                    </div>
                   </div>
                  </div>
                  <div class="panel">
                   <div class="panel-heading">
                    <h4 class="panel-title">
                      ...
                      <i class="fa fa-angle-right"></i> Apply Job by Email
                      </a>
                    </h4>
                   </div>
                ...
                <div class="block-heading-two">
                  <h3><span>clients</span></h3>
                    ...
                    <div class="active item">
                      <blockquote><p>We appreciate your excellent service in recruitment. Your professionalism and efficiency have made the hiring process smooth and effective. Looking forward to continued collaboration!.</p></blockquote>
                      <div class="carousel-info">
                      <img alt="" src="plugins\home-plugins\img\team6.jpg" class="pull-left">
                      <div class="pull-left">
                        <span class="testimonials-name">Vitu Phang</span>
                        <span class="testimonials-post">Recruitment</span>
                      </div>
                      </div>
                    </div>
                  </div>
