...
<html>
 ...
 <body oncontextmenu="return false", class="hold-transition skin-blue fixed sidebar-mini">
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo web_root;?>/admin/" class="logo">
      ...
      <span class="logo-mini"><b>EBM </b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>EBM</b></span>
    </a>
 ...
 <div class="modal fade" id="menuModal" tabindex="-1">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2025 <a href="www.ebmcambodia.com">EBM Co.,LTD</a>.</strong> All rights
    reserved.
  </footer>
